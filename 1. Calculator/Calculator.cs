...
namespace StackCalculator {
    ...
    public static class Calculator {
        ...
        private static readonly string[] ExtraFunctions = { "neg", "sin", "cos", "tg", "ctg", "ln" };
        ...
        private static void CalculateExtraFunction(string func, MyStack<double> operands, MyStack<string> functions, bool fromStack, ref Object prevtoken, double token = 0) {
            double temp = 0;
            if (fromStack) {
                temp = operands.Pop();
            }
        ...
        private static void PopFunction(MyStack<double> operands, MyStack<string> functions) {
            if (operands.Count < 2) {
        ...
        private static bool CanPop(string op, MyStack<string> functions) {
        ...
        public static double Calculate(String str, IDictionary<string, double> dict = null, GetVariable getVar = null) {
            ...
            var operands = new MyStack<double>();
